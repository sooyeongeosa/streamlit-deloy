...
conf_matrix_df = pd.DataFrame(conf_matrix, index=le_label.classes_, columns=le_label.classes_)
...
# Streamlit UI디자인
st.set_page_config(page_title="Obesity Dashbord", layout="wide")
# 사이드바 메뉴
...
def model_performance():
    ...
    sns.heatmap(conf_matrix, annot=True, cmap="Blues", fmt="d", xticklabels=le_label.classes_, yticklabels=le_label.classes_, ax=ax)
